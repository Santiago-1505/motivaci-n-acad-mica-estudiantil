...
public class GradeInMemoryRepositoryImpl implements GradeRepository {
  ...
  public List<Estudiante> devolverInformacionEstudiantes() {
    ...
    List<Estudiante> infoestudianteList =
        List.of(
            ...
            new Estudiante("Miguel Torres", 19, true, false, true, 2.1D,"Arauca"),
            ...
            new Estudiante("Luis Torres", 18, false, false, false,4.3D,"Antioquia"),
            ...
            new Estudiante("Claudia Gómez", 19, true, true, true,2.1D,"Nariño"));
    return infoestudianteList;
  }
}
